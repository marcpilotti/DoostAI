export function TypingIndicator() {
  return (
    <div className="flex items-start gap-2">
      <img src="/symbol.svg" alt="" width={20} height={20} className="mt-0.5 h-5 w-5 shrink-0" />
      <div className="flex items-center gap-2 rounded-2xl bg-muted/30 px-4 py-2">
        ...
        <span className="text-[11px] text-muted-foreground">skriver...</span>
      </div>
