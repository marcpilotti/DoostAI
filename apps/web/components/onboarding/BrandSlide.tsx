      ...
      <div className="w-full max-w-lg">
        ...
        >
          ...
          <div className="px-6 py-5">
            <button onClick={handleConfirm} className="flex w-full items-center justify-center gap-2 rounded-full bg-foreground px-5 py-3 text-[14px] font-semibold text-white transition-opacity hover:opacity-90">
