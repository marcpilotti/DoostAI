...
const PLATFORM_CONFIG: Record<Platform, { label: string; aspect: string }> = {
  instagram: { label: "Instagram", aspect: "4/5" },
  google: { label: "Google", aspect: "1.91/1" },
  linkedin: { label: "LinkedIn", aspect: "1.91/1" },
};
