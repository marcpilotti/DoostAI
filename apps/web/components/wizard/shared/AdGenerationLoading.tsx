...
const STEPS = [
  { label: "Analyserar din målgrupp", duration: 1500 },
  { label: "Skriver annonstext med AI", duration: 2500 },
  { label: "Genererar annonsbilder", duration: 3500 },
  { label: "Anpassar till plattformar", duration: 1500 },
  { label: "Slutjusterar", duration: 1500 },
];
