...
export function LinkedInAdPreview({ data }: { data: LinkedInAdData }) {
  ...
  return (
    <div className="w-full max-w-[480px] overflow-hidden rounded-lg border border-gray-200 bg-white font-sans text-xs text-gray-900 shadow-sm">
      {/* Post header */}
      ...
      <div className="flex items-center justify-around border-t border-gray-100 px-2 py-1">
        <button className="flex items-center gap-1.5 rounded px-3 py-2 text-gray-500 hover:bg-gray-50">
          ...
          <span className="text-xs">Gilla</span>
        </button>
        <button className="flex items-center gap-1.5 rounded px-3 py-2 text-gray-500 hover:bg-gray-50">
          <MessageCircle className="h-4 w-4" />
          <span className="text-xs">Kommentera</span>
        </button>
        <button className="flex items-center gap-1.5 rounded px-3 py-2 text-gray-500 hover:bg-gray-50">
          <Repeat2 className="h-4 w-4" />
          <span className="text-xs">Reposta</span>
        </button>
        <button className="flex items-center gap-1.5 rounded px-3 py-2 text-gray-500 hover:bg-gray-50">
